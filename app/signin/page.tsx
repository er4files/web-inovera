...
import { loginUser, saveAuthUser, isAuthenticated } from "@/lib/supabase";
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                ...
                {error && (
                  <div className="mb-6 rounded-sm bg-red-100 px-4 py-3 text-sm text-red-600 dark:bg-red-900/20 dark:text-red-400">
                    {error}
                  </div>
                )}
