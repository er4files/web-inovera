...
import { getBlogById, getAllBlogs } from "@/lib/supabase";
import Image from "next/image";
import { Metadata } from "next";
import { notFound } from "next/navigation";

// Generate static paths untuk semua blog IDs
...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
  ...
  if (!blog) {
    return {
      title: "Blog Not Found | PT Inoventra Era Nusantara",
    };
  }

  return {
    title: `${blog.title} | PT Inoventra Era Nusantara`,
...
const BlogDetailsPage = async ({ params }: { params: { id: string } }) => {
  ...
  const formattedDate = new Date(blog.publish_date).toLocaleString('id-ID', {
    day: 'numeric',
    month: 'short',
    year: 'numeric',
    hour: 'numeric',
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  <div 
                    className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed prose dark:prose-invert max-w-none"
