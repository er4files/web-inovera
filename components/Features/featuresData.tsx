...
const featuresData: Feature[] = [
  {
    ...
    title: "TOBOX: Teknologi Out of the Box",
    paragraph:
      "TOBOX adalah perangkat IoT yang kami kembangkan untuk meningkatkan efisiensi dan produktivitas di sektor pertanian dan industri. Dengan fitur real-time dan kemampuan analitik, TOBOX membantu pengumpulan data dan pengelolaan sistem secara otomatis, memberikan solusi cerdas yang mudah diterapkan.",
  },

  {
    ...
    title: "E-Store: Era Digital Store",
    paragraph:
      "E-Store adalah platform e-commerce resmi PT Inoventra Era Nusantara, menyediakan berbagai produk teknologi canggih termasuk perangkat TOBOX. E-Store memberikan pengalaman berbelanja yang praktis dengan berbagai pilihan pembayaran dan pengiriman, menghadirkan kemudahan akses bagi pelanggan kami.",
  },

  {
    ...
    title: "EraDev Solutions: Penyedia Jasa IT",
    paragraph:
      "EraDev Solutions menawarkan jasa pengembangan aplikasi dan web yang inovatif, efisien, dan berkelanjutan. Kami menyediakan solusi IT untuk berbagai sektor, dengan fokus pada kemudahan integrasi dan penggunaan yang ramah lingkungan, mendukung transformasi digital yang berdampak bagi masa depan industri.",
  },
];
